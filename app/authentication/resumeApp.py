...
# train_data = pickle.load(open('/kaggle/input/resume-data/train_data.pkl','rb'))
tfidfd = pickle.load(open('tfidf.pkl', 'rb'))
clf = pickle.load(open('clf.pkl', 'rb'))
...
#             st.write("resume_bytes:", type(resume_bytes))
#             resume_text = resume_bytes.decode('utf-8')
#             st.write("resume_text:", type(resume_text))
#         except UnicodeDecodeError:
#             st.title("exept Category111111111:")
